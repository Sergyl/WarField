...
/*
 * Este script pertenece al asset UJoystick, y no se ha modificado nada de él. Mediante este script el joystick será sensible al tacto.
 * Este script solo tiene sentido en la versión Android.
 */

public class JoystickFunction : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
